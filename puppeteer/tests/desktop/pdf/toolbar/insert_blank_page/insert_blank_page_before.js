//Checking the insertion of the blank page before the source page
...
BlankPagePdf.blankPage("Insert blank page before");
EditPdf.clickEditPdf(false);

//checking that the insertion occurred before the original page

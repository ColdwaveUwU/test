...
Tester.sleep(600);
const isNotDisabled = Tester.waitSelector("#slot-btn-edittext .disabled");
if (isNotDisabled) {
...
Tester.keyUp("Control");
Tester.sleep(600);
const isDisabled = Tester.waitSelector("#slot-btn-edittext .disabled");
if (!isDisabled) {
...
Tester.sleep(600);
const isNotDisabledForButton = Tester.waitSelector("#slot-btn-edittext .disabled");
...
Tester.sleep(600);
const isDisabledForButton = Tester.waitSelector("#slot-btn-edittext .disabled");

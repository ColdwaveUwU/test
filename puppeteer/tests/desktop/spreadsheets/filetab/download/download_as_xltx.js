// Test verifies downloading document in XLTX format and validates that the correct format is downloaded
const { FileMenu } = require("lib");

const requestedFormat = "xltx";
const expectedExtension = "xltx";

Tester.createFile("xlsx");
Tester.input("XLTXDownloadTest");

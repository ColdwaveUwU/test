// The test verifies the correctness of converting text to uppercase
...
Verification.check(filePath, xpath, inputText.toUpperCase());
if (!Verification.isSuccess()) {
    throw new Error("Change case to upper was not applied in the exported file");
}
Tester.close();

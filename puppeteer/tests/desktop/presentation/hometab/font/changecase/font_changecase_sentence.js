// The test verifies the correctness of converting text to Sentence case
const { Font, Verification, FileMenu } = require("lib");
const fileName = "pptx";
const inputText = "sentence case test.";
...
if (!Verification.isSuccess()) {
    throw new Error("Change case to sentence case was not applied in the exported file");
}
Tester.close();

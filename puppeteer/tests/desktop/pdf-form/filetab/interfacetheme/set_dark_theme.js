// This test verifies that Dark theme can be applied via File Advanced Settings: creates PDF-form, applies Dark theme, waits for theme-dark CSS class on body element using checkSelector

...
// Select Lines shape - Curved double-arrow connector type
Shape.clickLineShape(8);
Shape.drawShape();
...
Verification.check(
    "word/document.xml",
    "//mc:AlternateContent[1]/mc:Choice[1]/w:drawing[1]/wp:anchor[1]/a:graphic[1]/a:graphicData[1]/wps:wsp[1]/wps:spPr[1]/a:ln[1]/a:headEnd[1]/@type",
    "arrow"
);

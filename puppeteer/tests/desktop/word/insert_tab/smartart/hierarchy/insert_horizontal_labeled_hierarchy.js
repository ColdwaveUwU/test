...
// add hierarchy smart art - Horizontal labeled hierarchy
SmartArt.clickHierarchyArt(2);
...
Verification.check(
    "word/diagrams/data1.xml",
    "//dgm:dataModel[1]/dgm:ptLst[1]/dgm:pt[70]/dgm:prSet[1]/@presName",
    "spComp"
);

Verification.check(
    "word/diagrams/data1.xml",
    "//dgm:dataModel[1]/dgm:ptLst[1]/dgm:pt[71]/dgm:prSet[1]/@presName",
    "hSp"
);

Verification.check(
    "word/diagrams/data1.xml",
    "//dgm:dataModel[1]/dgm:ptLst[1]/dgm:pt[72]/dgm:prSet[1]/@presName",
    "rectComp"
);

Verification.check(
    "word/diagrams/data1.xml",
    "//dgm:dataModel[1]/dgm:ptLst[1]/dgm:pt[73]/dgm:prSet[1]/@presName",
    "bgRect"
);

Verification.check(
    "word/diagrams/data1.xml",
    "//dgm:dataModel[1]/dgm:ptLst[1]/dgm:pt[74]/dgm:prSet[1]/@presName",
    "bgRectTx"
);

// test the border type outer-table in a document table
...
Table.setTableAdvancedSettings({
    ...
    backgroundBorder: {
        border: { size: "1 pt" },
        borderType: "outer-table",
    },
});
FileMenu.downloadAs("docx");
// Getting verification results
Verification.openFile();
Verification.check("word/document.xml", "//w:tblBorders[1]/w:top[1]/@w:sz", "8");
Verification.check("word/document.xml", "//w:tblBorders[1]/w:left[1]/@w:sz", "8");
Verification.check("word/document.xml", "//w:tblBorders[1]/w:bottom[1]/@w:sz", "8");
Verification.check("word/document.xml", "//w:tblBorders[1]/w:right[1]/@w:sz", "8");

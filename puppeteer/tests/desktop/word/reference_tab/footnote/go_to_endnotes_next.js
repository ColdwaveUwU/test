...
Footnote.goToEndnotes("next", 2);
Tester.input("I'm standing here");

FileMenu.downloadAs("docx");
// Getting verification results
Verification.openFile();
Verification.check("word/document.xml", "//w:r[2]/w:t[1]/text()[1]", "I’m standing here");

// Test for swap endnotes and footnotes
...
Verification.check("word/document.xml", "count(//w:p[*]/w:r[2]/w:rPr[1]/w:rStyle[@w:val='183'])", 1);
Verification.check("word/document.xml", "count(//w:p[*]/w:r[2]/w:rPr[1]/w:rStyle[@w:val='186'])", 2);

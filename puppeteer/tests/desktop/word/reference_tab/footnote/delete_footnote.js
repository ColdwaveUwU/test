...
Footnote.deleteAllNotes(true, false);
FileMenu.downloadAs("docx");
// Getting verification results
Verification.openFile();
Verification.check("word/document.xml", "count(//w:endnoteReference[1]/@w:id)", 1);
Verification.check("word/document.xml", "count(//w:footnoteReference[1]/@w:id)", 0);

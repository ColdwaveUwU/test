// test script for verifying the "Leader None" setting in Table of Contents in a DOCX file
...
// Set the Table of Contents settings to "Leader None"
...
Verification.check("word/document.xml", "//w:p[1]/w:pPr[1]/w:tabs[1]/w:tab[1]/@w:leader", "none");

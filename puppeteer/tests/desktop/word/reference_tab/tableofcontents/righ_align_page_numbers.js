// test code for verifying the right alignment of page numbers in Table of Contents in a DOCX file
...
Verification.check("word/document.xml", "count(//w:p[*]/w:hyperlink[1]/w:r[4]/w:tab[1])", 0);
...
// Getting verification results
Verification.openFile();
Verification.check("word/document.xml", "count(//w:p[*]/w:hyperlink[1]/w:r[4]/w:tab[1])", 3);

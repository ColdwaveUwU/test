// test checking added text for Level 6 in a DOCX file
...
// Add text for Level 6 heading
TableOfContents.addText("Level 6");

FileMenu.downloadAs("docx");
// Getting verification results
Verification.openFile();
Verification.check("word/document.xml", "//w:pStyle[1]/@w:val", "144");

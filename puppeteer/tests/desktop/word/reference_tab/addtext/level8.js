// test checking added text for Level 8 in a DOCX file
...
// Add text for Level 8 heading
TableOfContents.addText("Level 8");

FileMenu.downloadAs("docx");
// Getting verification results
Verification.openFile();
Verification.check("word/document.xml", "//w:pStyle[1]/@w:val", "146");

// This test verifies that the sentence case change functionality works correctly in a document
const { Font, Verification, FileMenu } = require("lib");

const fileName = "docx";
const inputText = "sentence CASE Test EXAMPLE";
const expectedText = "Sentence case test example";

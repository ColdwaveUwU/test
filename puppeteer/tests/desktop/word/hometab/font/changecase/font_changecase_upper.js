// This test verifies that the uppercase case change functionality works correctly in a document
...
if (!Verification.isSuccess()) {
    throw new Error("Uppercase case change was not applied correctly");
}

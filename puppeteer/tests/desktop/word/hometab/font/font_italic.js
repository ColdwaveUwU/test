// This test verifies that the Italic style is correctly applied to the entered text in a document
...
const italicXpath = "//w:document[1]/w:body[1]/w:p[1]/w:r[1][w:rPr/w:i]/w:t[text()='" + inputText + "']";

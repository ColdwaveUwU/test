...
// Apply lowercase letters numbering list formatting with list level 4
TextForm.clickNumbering("aBrace");
Tester.waitAutosave();
TextForm.changeNumberingListLevel("Level 4");
...
Verification.check("word/document.xml", "//w:p[1]/w:pPr/w:numPr/w:ilvl/@w:val", "3");

...
// Apply lowercase letters numbering list formatting with list level 7
TextForm.clickNumbering("aBrace");
Tester.waitAutosave();
TextForm.changeNumberingListLevel("Level 7");
...
Verification.check("word/document.xml", "//w:p[1]/w:pPr/w:numPr/w:ilvl/@w:val", "6");

...
// Apply symbols multilevel formatting and change level: 1 -> 2 -> 1
TextForm.clickMultilevels("symbols");
Tester.waitAutosave();
TextForm.changeMultilevelListLevel("Level 2");
TextForm.changeMultilevelListLevel("Level 1");
...
Verification.check("word/document.xml", "//w:p[1]/w:pPr/w:numPr/w:ilvl/@w:val", "0");

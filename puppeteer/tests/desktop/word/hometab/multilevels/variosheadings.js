// Check setting various headings multilevel list formatting
...
// Apply various headings multilevel list formatting
TextForm.clickMultilevels("variosheadings");
...
Verification.check("word/numbering.xml", "//w:lvl[1]/w:lvlText/@w:val", "Chapter %1");

// This test verifies that document dark mode can be enabled with Contrast Dark theme
const { FileMenu, Verification } = require("lib");

const fileName = "docx";
const inputText = "DocumentDarkModeContrastTest";
...
if (!Verification.isSuccess()) {
    throw new Error("Document with dark mode enabled (contrast dark theme) does not contain the expected text");
}

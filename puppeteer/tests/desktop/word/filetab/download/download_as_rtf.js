// Test verifies downloading document in RTF format and validates that the correct format is downloaded
const { FileMenu } = require("lib");

const requestedFormat = "rtf";
const expectedExtension = "rtf";

Tester.createFile("docx");
Tester.input("RTFDownloadTest");

// Test verifies downloading document in TXT format and validates that the correct format is downloaded
const { FileMenu } = require("lib");

const requestedFormat = "txt";
const expectedExtension = "txt";

Tester.createFile("docx");
Tester.input("TXTDownloadTest");

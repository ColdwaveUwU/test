// Test verifies downloading document in DOTX format and validates that the correct format is downloaded
const { FileMenu } = require("lib");

const requestedFormat = "dotx";
const expectedExtension = "dotx";

Tester.createFile("docx");
Tester.input("DOTXDownloadTest");

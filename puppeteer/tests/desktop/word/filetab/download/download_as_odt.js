// Test verifies downloading document in ODT format and validates that the correct format is downloaded
const { FileMenu } = require("lib");

const requestedFormat = "odt";
const expectedExtension = "odt";

Tester.createFile("docx");
Tester.input("ODTDownloadTest");

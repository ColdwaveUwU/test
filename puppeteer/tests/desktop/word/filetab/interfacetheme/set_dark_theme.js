// This test verifies that Dark theme can be applied via File Advanced Settings: creates document, applies Dark theme, waits for theme-dark CSS class on body element using checkSelector

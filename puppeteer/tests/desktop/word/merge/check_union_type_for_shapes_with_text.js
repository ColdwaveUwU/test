//The test checks the text in the form after applying the "Union" type
//https://bugzilla.onlyoffice.com/show_bug.cgi?id=72381
...
MergeShapes.setMergeShapes("Union");
...
Verification.check("word/document.xml", "count(//a:cubicBezTo)", 5);

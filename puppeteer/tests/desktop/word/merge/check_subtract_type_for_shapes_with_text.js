//The test checks the text in the form after applying the "Subtract" type
...
MergeShapes.setMergeShapes("Subtract");
...
Verification.check("word/document.xml", "count(//a:cubicBezTo)", 7);

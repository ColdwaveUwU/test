...
const ChartSelectors = {
    ...
    EDIT_CHART: {
        ...
        LAYOUT_SETTINGS: {
            ...
            SERIES: "#chart-dlg-check-series label.checkbox__shape",
            CATEGORY: "#chart-dlg-check-category label.checkbox__shape",
            VALUE: "#chart-dlg-check-value label.checkbox__shape",
        },
        V_AXIS: {
            V_AXIS: "#slot-category-id-chart-settings-dlg-vert",
            HIDE_AXIS: "#chart-dlg-chk-vert-hide-0 label.checkbox__shape",
            ...
            REVERSE: "#chart-dlg-check-v-reverse-0 label.checkbox__shape",
            LOG_SCALE: "#chart-dlg-check-v-logscale-0 label.checkbox__shape",
        ...
        H_AXIS: {
            ...
            HIDE_AXIS: "#chart-dlg-chk-hor-hide-0 label.checkbox__shape",
            ...
            REVERSE: "#chart-dlg-check-h-reverse-0 label.checkbox__shape",
